<section>
    <div class="container-fluid lookup-div text-right">
        ...
        <div class="col-md-8 text-left">
            <div class="lookup-form">
                <form class="form-inline" method="post" action="<?php echo e(route('save_lookup')); ?>">
    ...
    <?php echo $__env->make('home.layouts.Message_index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</section>